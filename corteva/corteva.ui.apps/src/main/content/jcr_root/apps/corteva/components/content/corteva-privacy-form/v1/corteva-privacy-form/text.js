...
use(["/libs/wcm/foundation/components/utils/AuthoringUtils.js"], function (AuthoringUtils) {
    ...
    var before= granite.resource.properties[CONST.PROP_TEXT1]
            || "";
	 text.item.push(before);

    var after= granite.resource.properties[CONST.PROP_TEXT2]
            || "";
	 text.item.push(after);
